...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('bank.update',$bank) }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('bank_name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('bank_name') ? ' is-invalid' : '' }}" name="bank_name" id="input-name" type="text" placeholder="{{ __('Ex : State Bank of India') }}" value="{{ old('bank_name',$bank->bank_name) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('account_no') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('account_no') ? ' is-invalid' : '' }}" name="account_no" id="input-number" type="number" placeholder="{{ __('Ex : 78747421457') }}" value="{{ old('account_no',$bank->account_no) }}" required />
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-balance">{{ __(' Balance') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('balance') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('balance') ? ' is-invalid' : '' }}" input type="number" name="balance" id="input-balance" placeholder="{{ __('10000') }}" value="{{ old('balance',$bank->balance) }}" required />
